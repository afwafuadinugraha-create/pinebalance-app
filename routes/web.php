...
Route::get('/api/pg-summary-all', [WaterBalanceController::class, 'getSummaryAllPG']);
Route::get('/api/pg-irrigation-monthly-all', [WaterBalanceController::class, 'getMonthlyIrrigationAllPG']);
